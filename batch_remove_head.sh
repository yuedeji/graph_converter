...
#    python edge_list_to_GTgraph.py /mnt/raid0_huge/yuede/data/${file[$1]}/edge_list.txt /mnt/raid0_huge/yuede/data/${file[$1]}/gtgraph.txt
    ...
    echo "sed 1d /mnt/raid0_huge/yuede/data/${file[$1]}/edge_list.txt > /mnt/raid0_huge/yuede/data/${file[$1]}/edge_list_no_head.txt"

    sed 1d /mnt/raid0_huge/yuede/data/${file[$1]}/edge_list.txt > /mnt/raid0_huge/yuede/data/${file[$1]}/edge_list_no_head.txt
